...
const t = () => Math.random().toString(36).substring(7).split("").join("."), n = {
    INIT: `@@redux/INIT${t()}`,
...
function o(t, r, i) {
    if ("function" == typeof r && "function" == typeof i || "function" == typeof i && "function" == typeof arguments[3]) throw Error("It looks like you are passing several store enhancers to createStore(). This is not supported. Instead, compose them together to a single function.");
    if ("function" == typeof r && void 0 === i && (i = r, r = void 0), void 0 !== i) {
    ...
    function h(e) {
        ...
        return d(), a.push(e), function () {
            if (!t) return;
            if (f) throw Error("You may not unsubscribe from a store listener while the reducer is executing. See https://redux.js.org/api-reference/store#subscribe(listener) for more details.");
            t = !1, d();
            const n = a.indexOf(e);
            a.splice(n, 1)
        }
    ...
    return p({type: n.INIT}), {
        dispatch: p, subscribe: h, getState: l, replaceReducer: function (e) {
            if ("function" != typeof e) throw Error("Expected the nextReducer to be a function.");
            u = e, p({type: n.REPLACE})
        }, [e]: function () {
            const t = h;
            return {
                subscribe(e) {
...
function i(e) {
    ...
    try {
        !function (e) {
            Object.keys(e).forEach(t => {
                const o = e[t];
                if (void 0 === o(void 0, {type: n.INIT})) throw Error(`Reducer "${t}" returned undefined during initialization. ` + "If the state passed to the reducer is undefined, you must explicitly return the initial state. The initial state may not be undefined. If you don't want to set a value for this reducer, you can use null instead of undefined.");
                if (void 0 === o(void 0, {type: n.PROBE_UNKNOWN_ACTION()})) throw Error(`Reducer "${t}" returned undefined when probed with a random type. ` + `Don't try to handle ${n.INIT} or other actions in "redux/*" ` + "namespace. They are considered private. Instead, you must return the current state for any unknown actions, unless it is undefined, in which case you must return the initial state, regardless of the action type. The initial state may not be undefined, but can be null.")
            })
        }(o)
    } catch (e) {
        u = e
    ...
    return function (e = {}, t) {
        ...
        let n = !1;
        const s = {};
        for (let u = 0; i.length > u; u++) {
            const c = i[u], a = e[c], f = (0, o[c])(a, t);
            if (void 0 === f) {
                const e = r(c, t);
                throw Error(e)
            }
...
function a(...e) {
    return t => (...n) => {
        ...
        const i = {getState: o.getState, dispatch: (...e) => r(...e)}, u = e.map(e => e(i));
        return r = c(...u)(o.dispatch), {...o, dispatch: r}
    }
}
